...
- [Auth0](https://auth0.com/guest-authors) - Up to $300 per piece (SEPTEMBER 2023 UPDATE: Applications are closed)
  > Technical tutorials with code. Pick from a list of possible articles.

- [CircleCI](https://circleci.com/blog/guest-writer-program/)  - Up to $300 per piece
  > Technical tutorials with code. Pick from a list of possible articles.

- [Clubhouse.io](https://clubhouse.io/clubhouse-write-earn-give-program/) - Up to $600 per piece (SEPTEMBER 2023 UPDATE: Error 404)  
...
- [Code Magic](https://blog.codemagic.io/write-for-codemagic-ci-cd/) - Applications are currently closed. (SEPTEMBER 2023 UPDATE: Looking for Flutter writers as per the website)  
  > Technical focused articles.Specific on Flutter.

- [Couchbase](https://www.couchbase.com/community/community-writers-program) - $200 per piece (SEPTEMBER 2023 UPDATE: Page not found)  
  > Content area experts can submit tutorials and blog content.

- [CSS Tricks](https://css-tricks.com/guest-posting/) - Around $250 per piece (depends on the length, research and audience) (SEPTEMBER 2023 UPDATE: Temporarily closed to new guest posts)  
...
- [Digital Ocean](https://www.digitalocean.com/write-for-donations/) - Up to $400 per piece (SEPTEMBER 2023 UPDATE: Temporarily closed)  
  > Technical tutorials with code. Not limited to Digital Ocean products.

- [Draft](https://draft.dev/#write) - Pays $200-$400 per piece
  > Technical content production agency that works with many clients.
  
- [DZone](https://dzone.com/writers-zone) - Waiting for details [https://dzone.com/pages/contribute]
...
- [FaunaDB](https://github.com/fauna/write-with-fauna) - $200-$500 per piece
...
- [Honeybadger](https://www.honeybadger.io/blog/write-for-us/) - From $500 per piece (SEPTEMBER 2023 UPDATE: Not reviewing new submissions)  
  > Ruby and Elixir tutorials with code. Pick from a list of possible articles.

- [Linode](https://www.linode.com/docs/contribute/) - Up to $300 per piece (SEPTEMBER 2023 UPDATE: Not accepting new applications)  
  > Technical tutorials with code on Linux or Linode.

- [LoginRadius](https://www.loginradius.com/blog/async/page/guest-blog) - Up to $200 per piece (SEPTEMBER 2023 UPDATE: Page not found)  
  > Technical tutorials with code. Not limited to LoginRadius products.

- [LogRocket](https://blog.logrocket.com/become-a-logrocket-guest-author-7d970eb673f9/) - Up to $350 per piece (SEPTEMBER 2023 UPDATE: Not accepting new applications)  
  > Technical tutorials with code. Write about anything frontend.

- [Make Use Of](https://www.makeuseof.com/contributor/) - $120 per piece with performance benefits (SEPTEMBER 2023 UPDATE: No roles at this time)  
  > Tutorials and features about consumer apps and software products.

- [Mixster](https://mixstersite.wordpress.com/2019/05/24/mixster/#more-2253) (SEPTEMBER 2023 UPDATE: Not hiring at the moment)  
...
- [Nimblebox.ai](https://nimblebox.ai/technical-writer-program) - $100 per article (SEPTEMBER 2023 UPDATE: Join now button on the page not working)  
...
- [Rancher](https://rancher.com/writing-program/roles/writer/) - $300 per piece (SEPTEMBER 2023 UPDATE: Error 404)  
  > Writing about devops, Kubernetes, and Rancher.

- [Real Python](https://realpython.com/write-for-us/) - Up to $300 per piece (SEPTEMBER 2023 UPDATE: No longer available)  
  > Technical tutorials with code. Pick from a list of possible articles.

- [Section.io](https://github.com/section-io/engineering-education) (SEPTEMBER 2023 UPDATE: Error 404)  
...
- [Soshace](https://soshace.com/write-for-us/) - $100 per piece
  > Technical tutorials with code. Submit your own articles in the following niches: Web development (Angular, React.js, Node.js, Vue.js. PHP, Java, Python), remote work 
...
- [Twilio](https://www.twilio.com/en-us/voices) - Up to $500 per piece
  > Technical tutorials with code. Doesn't necessarily have to use Twilio.
  
- [Vonage](https://developer.nexmo.com/spotlight/) - $500 per piece (SEPTEMBER 2023 UPDATE: Not accepting new applications) 
...
- [Vultr](https://www.vultr.com/docs/vultr-docs-program-guidelines) - Up to $300 per piece
  > most topic take a look on Vultr document. Paid via PayPal

- [WPHUB](https://www.wphub.com/write-for-us/) - $200 per piece (SEPTEMBER 2023 UPDATE: Page not found) 
